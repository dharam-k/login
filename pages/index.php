    ...
    <div class="main">
        ...
        <div class="container b-container" id="b-container">
            <form class="form" id="b-form" method="post" action="">
                <?php  if($notfound){
                  ?>
                  <div class="alert alert-danger alert-dismissible fade show" style="margin-left: 70px;" role="alert">
                ...
                <input class="form__input" name="password" type="password" placeholder="Password"><a class="form__link">Forgot your
                    password?</a>
                <input type="submit" name="submit" class="form__button button" value="SIGN IN">
                <!-- <button name="submit" class="form__button button submit">SIGN IN</button> -->
            </form>
        </div>
    </div>
